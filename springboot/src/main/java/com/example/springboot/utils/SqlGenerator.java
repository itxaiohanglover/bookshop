...
public class SqlGenerator {
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "C:\\Users\\artboy\\Desktop\\bookmall\\bookshop\\BookShop\\src\\main\\java\\com\\example\\springboot\\entity";
        //生成sql的文件夹
        String filePath = "F:\\sqlGen";
        //项目中实体类的路径
        String prefix = "com.example.springboot.entity.";
        String className = "";
